...
#########################################################################################
TOTAL_BATCH = 20
positive_file = 'save/trump.id.txt'
negative_file = 'save/trump_sample.txt'
eval_file = 'save/eval_trump.txt'
...
def main():
    ...
    if ckpt and ckpt.model_checkpoint_path:
        ...
        print('Transferring to Trump Style')
    ...
    discriminator.model.save('./checkpoints/discriminator/trump_discriminator.h5')
